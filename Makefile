...
test-debug: clean
	py.test -s -x --pdb -vvvv --doctest-modules --junit-xml=unittest.xml tests lain_sdk/yaml/parser.py lain_sdk/util.py
...
clean:
	...
	- rm -rf dist build lain_sdk.egg-info einplus_lain_sdk.egg-info .coverage htmlcov unittest.xml
